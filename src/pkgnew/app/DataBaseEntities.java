...
public class DataBaseEntities extends javax.swing.JFrame {

    DbConnection db;
    ConnectComPort cp;
    ResultSet rs;
    public static DataBaseEntities obj = null;
    ...
    public static DataBaseEntities getObj() {
        if (obj == null) {
    ...
    public void creattion() {
        ...
        try {
            ...
            String sql = "CREATE TABLE Connexion "
                    + "(ID INT PRIMARY KEY     NOT NULL,"
                    + " IP        CHAR(50)    NOT NULL, "
                    + " DB        CHAR(50)    NOT NULL, "
                    + " PSE        CHAR(50)    NOT NULL, "
                    + " PASS      CHAR(50) )";
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Parametre connection");
        ...
        setSize(new java.awt.Dimension(371, 408));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txIP.getText().equals("") || txDB.getText().equals("") || txUt.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Parametres sauvgardes");
            txIP.setText("");
            txDB.setText("");
            txUt.setText("");
            txPss.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String[] inf = {"1", "localhost", "parcelcube", "root", ""};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataBaseEntities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataBaseEntities().setVisible(true);
            }
        });
    }
