...
public class ProduitEntrantDeux extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static ProduitEntrantDeux obj = null;

    public ProduitEntrantDeux() {
    ...
    public static ProduitEntrantDeux getObj() {
        if (obj == null) {
            obj = new ProduitEntrantDeux();
        }
        return obj;
    }

    public void table() {
        String a[] = {"Numero", "Code_produit", "Designation_produit", "Code_type", "Nom_type", "Date", "Heure", "Pesage"};
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ProduitEntrantDeux.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduitEntrantDeux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProduitEntrantDeux().setVisible(true);
            }
        });
    }
