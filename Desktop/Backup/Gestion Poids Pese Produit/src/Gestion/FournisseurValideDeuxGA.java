...
public class FournisseurValideDeuxGA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public FournisseurValideDeuxGA() {
    ...
    void removeTitleBar() {
        putClientProperty("FournisseurValideDeuxGA.isPalette", Boolean.TRUE);
    ...
    public void toPDFMat() {
        ...
        try {
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, "BonFournisseurValideDeux.pdf");
            File file = new File("BonFournisseurValideDeux.pdf");
            ...
            Logger.getLogger(FournisseurValideDeuxGA.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void toPDF2() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("RapportFournisseurDeux.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    public void toPDF3() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("MvFournisseurDeux.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Numero", "Code Fournisseur", "Code de produit", "Masse Nette" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Numero", "Code Fournisseur", "Code de produit", "Masse Nette" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (mouvement.equals(" ")) {
            ...
            if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
                ...
                rs = db.querySelectTwoALL("fournisseur_valide_deux", text1 + "='" + jTextField1.getText() + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
            }
        } else {

            if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
                rs = db.querySelectTwoOne("fournisseur_valide_deux", text3 + "='" + mouvement + "'", text, deb, fin);
            } else {
                ...
                rs = db.querySelectThreeALL("fournisseur_valide_deux", text1 + "='" + jTextField1.getText() + "'", text3 + "='" + mouvement + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
            }
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(FournisseurValideDeuxGA.this);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (Numero.equals("null")) {
            ...
            String CodeFournisseur = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 3));
            String NomFournisseur = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 4));
            ...
            rs = db.querySelectAll("fournisseur", "Code='" + CodeFournisseur + "'");
            ...
            if (Imprimante.getText().equals("Normale A4")) {
                ...
                String[] inf3 = {Numero, mouvement, "Fournisseur", CodeFournisseur, NomFournisseur, clientAdress, CodeProduite, DesignationProduit, produitLot,
                ...
                TicketDeux ticket = new TicketDeux(txnomSoc.getText(), txAdresseSoc.getText(), txTelSoc.getText(), txFaxSoc.getText(), Numero, mouvement,
                        "client", CodeFournisseur, NomFournisseur, clientAdress, CodeProduite, DesignationProduit, produitLot, produitPrix, prouitCoefficient,
                        Date, heure, Pesage);
                ticket.print();
            }
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
            ...
            rs = db.querySelectTwoALL("fournisseur_valide_deux", "Code_fournisseur='" + jTextField1.getText() + "'", "Code_produit='" + jTextField2.getText() + "'", text, deb, fin);
            ...
            if (test.equals("null")) {
                ...
                db.queryDelete("mv_fournisseur_deux");
                float c = 0;
                float v = 0;
                ...
                for (int j = 0; j < jTable20.getRowCount(); j++) {
                    ...
                    String[] colon = {"Id", "Code_fournisseur", "Nom_fournisseur", "Adresse_fournisseur", "Produit", "Designation_produit", "Date", "Heure", "Pesage", "Totale_Entrer", "Totale_Sortie", "Date_debut", "Date_fin", "Etat"};
                    ...
                    System.out.println(db.queryInsert("mv_fournisseur_deux", colon, inf));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        table11();
        table10();
        db.queryDelete("rapport_fournisseur_deux");
        ...
        for (int i = 0; i < jTable11.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable10.getRowCount(); j++) {
                ...
                // System.out.println("Code produit: " + CodeProduit);
                rs = db.querySelectTwoALL("fournisseur_valide_deux", "Code_fournisseur='" + CodeClient + "'", "Code_produit='" + CodeProduit + "'", text, deb, fin);
                jTable20.setModel(new ResultSetTableModel(rs));
                ...
                if (Float.parseFloat(TotaleEntrer) != 0 || Float.parseFloat(TotaleSortie) != 0) {
                    ...
                    System.out.println(db.queryInsert("rapport_fournisseur_deux", colon, inf));
                    NomClient = "#######";
                    AdresseClient = "#######";
                    dd = true;
                }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (Numero.equals("null")) {
            ...
            if (JOptionPane.showInputDialog(this, "Veuillez saisir votre mot de passe Directeur :", "Verification", JOptionPane.OK_CANCEL_OPTION).equals(password1)) {
                ...
                db.queryDelete("fournisseur_valide_deux", "Id=" + id);
                Date s = new Date();
                ...
                String[] inf = {id, "Fournisseur valide", IdProduit, ProduitNom, Numero, CodeClient, CodeProduit, Date, Heure, Pesage, txDate + " " + txHeure, hostName};
                System.out.println(db.queryInsert("Suppression_deux", colon, inf));

                table();
                JOptionPane.showMessageDialog(this, "Le fournisseur valide a été supprimé avec succès.");
            } else {
                getToolkit().beep();
