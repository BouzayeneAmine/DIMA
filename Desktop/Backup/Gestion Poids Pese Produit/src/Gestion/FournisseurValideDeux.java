...
public class FournisseurValideDeux extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static FournisseurValideDeux obj = null;

    public FournisseurValideDeux() {
    ...
    public static FournisseurValideDeux getObj() {
        if (obj == null) {
            obj = new FournisseurValideDeux();
        }
        return obj;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(FournisseurValideDeux.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FournisseurValideDeux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FournisseurValideDeux().setVisible(true);
            }
        });
    }
