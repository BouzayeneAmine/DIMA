...
public class ProduitSortantDeuxA extends javax.swing.JInternalFrame {

    ResultSet rs;
    DbConnection db;

    public ProduitSortantDeuxA() {
    ...
    void removeTitleBar() {
        putClientProperty("ProduitSortantDeuxA.isPalette", Boolean.TRUE);
    ...
    public void table() {
        String a[] = {"Numero", "Code_produit", "Designation_produit", "Code_type", "Nom_type","Nfabrication","Nenroleur","Laize","Grammage", "Date", "Heure", "Pesage","tare"};
    ...
    public void table30() {
        ...
        rs = db.querySelect(a, "rapport_produit_sortant_deux");
    ...
    public void table40() {
        ...
        rs = db.querySelect(a, "mv_produit_sortant_deux");
    ...
    public void toPDF2() {
        ...
        try {
            ...
            InputStream path = this.getClass().getResourceAsStream("RapportProduitSortantDeux.jrxml");
    ...
    public void toPDF3() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("MvProduitSortantDeux.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    public void toPDF4() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("RapportProduitSortantTotaleDeux.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
            rs = db.querySearchAll("produit_sortant_deux", text, deb, fin);
        } else {
            String text1 = "Numero";
            String text2 = "Numero ";
            ...
            rs = db.querySelectTwoALL("produit_sortant_deux", text1 + "='" + jTextField1.getText() + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ProduitSortantDeuxA.this);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
            ...
            if (testType == true) {
                ...
                rs = db.querySelectTwoALL("produit_sortant_deux", "code_type='" + jTextField1.getText() + "'", "Code_produit='" + jTextField2.getText() + "'", text, deb, fin);
                ...
                if (test.equals("null")) {
                    ...
                    db.queryDelete("mv_produit_sortant_deux");
                    float c = 0;
                    for (int k = 0; k < jTable20.getRowCount(); k++) {
                        String b = String.valueOf(jTable20.getValueAt(k, 12)).replace(',', '.');
                    ...
                    for (int j = 0; j < jTable20.getRowCount(); j++) {
                        ...
                        String Date = String.valueOf(jTable20.getValueAt(j, 10));
                        String Heure = String.valueOf(jTable20.getValueAt(j, 11));
                        String Pesage = String.valueOf(jTable20.getValueAt(j, 12));
                        idd = idd + 1;
                        ...
                        System.out.println(db.queryInsert("mv_produit_sortant_deux", colon, inf));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        db.queryDelete("rapport_produit_sortant_deux");
        ...
        for (int i = 0; i < jTable10.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable11.getRowCount(); j++) {
                ...
                rs = db.querySelectTwoALL("produit_sortant_deux", "code_type='" + CodeType + "'", "Code_produit='" + CodeProduit + "'", text, deb, fin);
                jTable20.setModel(new ResultSetTableModel(rs));
                ...
                if (Float.parseFloat(Totale) != 0) {
                    ...
                    System.out.println(db.queryInsert("rapport_produit_sortant_deux", colon, inf));
                    DesProduit = "#######";
                }
            }
            Type = "Fournisseur";
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        table10();
        db.queryDelete("rapport_produit_sortant_totale_deux");
        jProgressBar1.setMaximum(jTable10.getRowCount() - 1);
        for (int i = 0; i < jTable10.getRowCount(); i++) {
            String CodeProduit = String.valueOf(jTable10.getValueAt(i, 1));
            String DesProduit = String.valueOf(jTable10.getValueAt(i, 2));

            rs = db.querySelectTwoOne("produit_sortant_deux", "Code_produit='" + CodeProduit + "'", text, deb, fin);
            jTable20.setModel(new ResultSetTableModel(rs));
            ...
            if (c != 0) {
                ...
                System.out.println(db.queryInsert("rapport_produit_sortant_totale_deux", colon, inf));
            }
        }
        toPDF4();
