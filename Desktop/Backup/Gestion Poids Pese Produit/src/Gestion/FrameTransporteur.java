...
public class FrameTransporteur extends javax.swing.JFrame {

    ProgrammeDeux programmeDeux;
    ResultSet rs;
    DbConnection db;

    public FrameTransporteur(ProgrammeDeux p) {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(656, 638));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tranNom.getText().equals("") || tranCode.getText().equals("")) {
            ...
            programmeDeux.getTranNom = this.tranNom.getText();
            programmeDeux.getTranCode = this.tranCode.getText();
            programmeDeux.getTranAdress = this.tranAdress.getText();
            programmeDeux.postTransporteur();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameTransporteur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
