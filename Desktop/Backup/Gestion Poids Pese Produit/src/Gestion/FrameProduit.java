...
public class FrameProduit extends javax.swing.JFrame {
    ...
    public FrameProduit(ProgrammeDeux p) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (produitCode.getText().equals("") || produitDesignation.getText().equals("")) {
            ...
            programmeDeux.getProduitGrammage = this.produitPrix.getText();
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        } else if (jComboBox1.getSelectedItem().equals("Laize")) {
            rs = db.querySelectAll("produit", "Lot LIKE '%" + jTextField1.getText() + "%' ");
        } else if (jComboBox1.getSelectedItem().equals("Grammage")) {
