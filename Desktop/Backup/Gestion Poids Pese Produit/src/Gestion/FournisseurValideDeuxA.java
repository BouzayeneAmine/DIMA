...
public class FournisseurValideDeuxA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public FournisseurValideDeuxA() {
    ...
    void removeTitleBar() {
        putClientProperty("FournisseurValideDeuxA.isPalette", Boolean.TRUE);
    ...
    public void toPDFMat() {
        ...
        try {
            ...
            Logger.getLogger(FournisseurValideDeuxA.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 1007, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(FournisseurValideDeuxA.this);
        ...
        for (int i = 0; i < jTable11.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable10.getRowCount(); j++) {
                ...
                if (Integer.parseInt(TotaleEntrer) != 0 || Integer.parseInt(TotaleSortie) != 0) {
                    ...
                    idd = idd + 1;
                    id = String.valueOf(idd);
                    String[] colon = {"Id", "Code_fournisseur", "Nom_fournisseur", "Adresse", "Code_Produit", "Designation_Produit", "Totale_Entrer", "Totale_sortie", "Date_debut", "Date_fin"};
