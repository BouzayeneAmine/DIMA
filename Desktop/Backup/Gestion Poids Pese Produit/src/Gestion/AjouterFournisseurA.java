...
public class AjouterFournisseurA extends javax.swing.JInternalFrame {

    ResultSet rs;
    DbConnection db;

    public AjouterFournisseurA() {
    ...
    void removeTitleBar() {
        putClientProperty("AjouterFournisseurA.isPalette", Boolean.TRUE);
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Ajouter un fournisseur");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txCode, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
                    .addComponent(txNom)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        rs = db.querySelectAll("fournisseur", "Code='" + txCode.getText() + "'");
        ...
        if (txNom.getText().equals("") || txCode.getText().equals("") || txAdresse.getText().equals("")) {
            ...
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Ce code fournisseur existe déjà !", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else {
            ...
            actualiser();
            JOptionPane.showMessageDialog(this, "Le fournisseur a été ajouté avec succès.");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String id = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        if (txTest1.getText().equals("")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un fournisseur dans le tableau !", "Erreur", JOptionPane.ERROR_MESSAGE);
            ...
            if (JOptionPane.showConfirmDialog(this, "Etes-vous sûr de vouloir supprimer ce fournisseur ?", "Attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                db.queryDelete("fournisseur", "id=" + id);
                actualiser();
                JOptionPane.showMessageDialog(this, "Le fournisseur a été supprimé avec succès");
            }
        }
