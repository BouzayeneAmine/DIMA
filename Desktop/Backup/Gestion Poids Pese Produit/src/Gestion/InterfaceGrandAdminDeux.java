...
public class InterfaceGrandAdminDeux extends javax.swing.JFrame {

    BDD.License l;
    DbConnection db;

    public InterfaceGrandAdminDeux() {
        l = new BDD.License();
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/Images/Logo.png")).getImage());
        datecourante();
        this.pack();
        InterfaceGrandAdminDeux.setDefaultLookAndFeelDecorated(true);
        this.setExtendedState(InterfaceGrandAdminDeux.MAXIMIZED_BOTH);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jButton19, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(InterfaceGrandAdminDeux.class.getName()).log(Level.SEVERE, null, ex);
        }
        lc.show();
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        ClientValideDeuxGA lc = new ClientValideDeuxGA();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        ProduitSortantDeuxA lc = new ProduitSortantDeuxA();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        ListeSuppressionDeux lc = new ListeSuppressionDeux();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceGrandAdminDeux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceGrandAdminDeux().setVisible(true);
            }
        });
    }
