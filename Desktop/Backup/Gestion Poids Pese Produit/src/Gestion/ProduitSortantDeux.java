...
public class ProduitSortantDeux extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;

    public static ProduitSortantDeux obj = null;

    public ProduitSortantDeux() {
    ...
    public static ProduitSortantDeux getObj() {
        if (obj == null) {
            obj = new ProduitSortantDeux();
        }
        return obj;
    }

    public void table() {
        String a[] = {"Numero", "Code_produit", "Designation_produit", "Code_type", "Nom_type","Nfabrication","Nenroleur","Laize","Grammage", "Date", "Heure", "Pesage"};
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ProduitSortantDeux.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduitSortantDeux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProduitSortantDeux().setVisible(true);
            }
        });
    }
