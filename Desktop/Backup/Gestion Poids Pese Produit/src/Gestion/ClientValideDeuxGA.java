...
public class ClientValideDeuxGA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public ClientValideDeuxGA() {
    ...
    void removeTitleBar() {
        putClientProperty("ClientValideDeuxGA.isPalette", Boolean.TRUE);
    ...
    public void calcultotal() {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            String b = String.valueOf(jTable1.getValueAt(i, 13));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ClientValideDeuxGA.this);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (Numero.equals("null")) {
            ...
            String tare = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 14));
            ...
            String[] inf3 = {Numero, mouvement, "client", CodeClient, NomClient, clientAdress, CodeProduite, DesignationProduit, Laize,
                Nfabrication, Grammage, prouitCoefficient, Nenroleur, Date, Heure, Pesage,tare};
        ...
        for (int i = 0; i < jTable11.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable10.getRowCount(); j++) {
                ...
                if (Float.parseFloat(TotaleEntrer) != 0 || Float.parseFloat(TotaleSortie) != 0) {
                    ...
                    idd = idd + 1;
                    id = String.valueOf(idd);
                    String[] colon = {"Id", "Code_client", "Nom_client", "Adresse_client", "Code_Produit", "Designation_Produit", "Totale_Entrer", "Totale_sortie", "Date_debut", "Date_fin"};
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (Numero.equals("null")) {
            ...
            if (JOptionPane.showInputDialog(this, "Veuillez saisir votre mot de passe Directeur :", "Verification", JOptionPane.OK_CANCEL_OPTION).equals(password1)) {
                ...
                db.queryDelete("client_valide_deux", "Id=" + id);
                Date s = new Date();
                ...
                String[] inf = {id, "Client valide", IdProduit, ProduitNom, Numero, CodeClient, CodeProduit, Date, Heure, Pesage, txDate + " " + txHeure, hostName};
