...
public class TransporteurValideDeux extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static TransporteurValideDeux obj = null;

    public TransporteurValideDeux() {
    ...
    public static TransporteurValideDeux getObj() {
        if (obj == null) {
            obj = new TransporteurValideDeux();
        }
        return obj;
    }
    ...
    private void initComponents() {
        ...
        setTitle("LISTE TRANSPORTEURS VALIDES");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Numero", "Code Transporteur", "Code de produit", "Masse Nette" }));

        jLabel1.setText("De");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Numero", "Code Transporteur", "Code de produit", "Masse Nette" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(TransporteurValideDeux.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransporteurValideDeux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransporteurValideDeux().setVisible(true);
            }
        });
    }
