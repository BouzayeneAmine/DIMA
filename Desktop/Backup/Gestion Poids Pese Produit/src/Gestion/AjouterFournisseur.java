...
public class AjouterFournisseur extends javax.swing.JFrame {
    ...
    ResultSet rs;
    DbConnection db;
    public static AjouterFournisseur obj = null;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txNom, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                    .addComponent(txCode)
        ...
        setSize(new java.awt.Dimension(730, 669));
    ...
    private void txNomKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txNomKeyTyped
        ...
        if ((car == '\'') || (txNom.getText().length() > 24)) {
            getToolkit().beep();
            evt.consume();
        }
