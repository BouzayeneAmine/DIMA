...
public class TransporteurValideDeuxA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public TransporteurValideDeuxA() {
    ...
    void removeTitleBar() {
        putClientProperty("TransporteurValideDeuxA.isPalette", Boolean.TRUE);
    ...
    public void toPDFMat() {
        ...
        try {
            ...
            Logger.getLogger(TransporteurValideDeuxA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(TransporteurValideDeuxA.this);
        ...
        if (Numero.equals("null")) {
            ...
            if (Imprimante.getText().equals("Normale A4")) {
                ...
                String[] colon3 = {"Numero", "mouvement", "Type", "Code_type", "Nom_type", "Adresse_type", "Code_produit", "Designation_produit",
                    "Lot_produit", "Prix_produit", "Coefficient_produit", "Date", "Heure", "Pesage"};
                String[] inf3 = {Numero, mouvement, "Transpoteur", CodeTranspoteur, NomTranspoteur, clientAdress, CodeProduite, DesignationProduit, produitLot,
                    produitPrix, prouitCoefficient, Date, Pesage};
                System.out.println(db.queryUpdate("impression_bon_deux", colon3, inf3, "id='" + 0 + "'"));
                toPDFMat();
        ...
        for (int i = 0; i < jTable11.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable10.getRowCount(); j++) {
                ...
                if (Integer.parseInt(TotaleEntrer) != 0 || Integer.parseInt(TotaleSortie) != 0) {
                    ...
                    idd = idd + 1;
                    id = String.valueOf(idd);
                    String[] colon = {"Id", "Code_transporteur", "Nom_transporteur", "Adresse", "Code_Produit", "Designation_Produit", "Totale_Entrer", "Totale_sortie", "Date_debut", "Date_fin"};
