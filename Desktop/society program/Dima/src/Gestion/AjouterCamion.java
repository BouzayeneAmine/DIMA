...
public class AjouterCamion extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;

    public static AjouterCamion obj = null;

    public AjouterCamion() {
    ...
    public static AjouterCamion getObj() {
        if (obj == null) {

            obj = new AjouterCamion();
        }
        return obj;
    }
public void getTransporteur(){
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DAF", "Iveco", "Kenworth", "MAN ", "MAZ", "Mercedes", "Renault", "Remorque", "Scania", "Volvo", "Autre" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(40, 40, 40)
                                .addComponent(transporteur_combobox, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        setSize(new java.awt.Dimension(721, 835));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjouterCamion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjouterCamion().setVisible(true);
            }
        });
    }
