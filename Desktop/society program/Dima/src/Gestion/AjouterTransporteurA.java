...
public class AjouterTransporteurA extends javax.swing.JInternalFrame {

    ResultSet rs;
    DbConnection db;

    public AjouterTransporteurA() {
    ...
    void removeTitleBar() {
        putClientProperty("AjouterTransporteurA.isPalette", Boolean.TRUE);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txNom, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                    .addComponent(txCode)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (txTest1.getText().equals("")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un transporteur dans le tableau !", "Erreur", JOptionPane.ERROR_MESSAGE);
            ...
            if (JOptionPane.showConfirmDialog(this, "Etes-vous sûr de vouloir supprimer ce transporteur ?", "Attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                db.queryDelete("transporteur", "id=" + id);
                JOptionPane.showMessageDialog(this, "Le transporteur a été supprimé avec succès.");
                actualiser();
            }
        }
