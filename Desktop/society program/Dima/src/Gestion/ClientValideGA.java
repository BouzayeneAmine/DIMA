...
public class ClientValideGA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;
    private String TotaleSadminortie;

    public ClientValideGA() {
    ...
    void removeTitleBar() {
        putClientProperty("ClientValideGA.isPalette", Boolean.TRUE);
 ...
 public void toPDFA7() {
    ...
    public void toPDFMatA4() {
        ...
        try {
            ...
            Logger.getLogger(ClientValideGA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jScrollPane6.setViewportView(jClient);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ClientValideGA.this);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        for (int i = 0; i < jClient.getRowCount(); i++) {
            ...
            for (int j = 0; j < jProduit.getRowCount(); j++) {
                ...
                if (Integer.parseInt(TotaleEntrer) != 0 || Integer.parseInt(TotaleSadminortie) != 0) {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (Numero.equals("null")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner dans le tableau un client à supprimer !", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else {
            String password1 = "";
            ...
            if (JOptionPane.showInputDialog(this, "Veuillez saisir votre mot de passe Directeur :", "Verification", JOptionPane.OK_CANCEL_OPTION).equals(password1)) {
                ...
                String Date_deuxieme = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 10)).replace(',', '.');
                float dPremier = Float.parseFloat(Premier_pesage);
                float dDeuxieme = Float.parseFloat(Date_deuxieme);
                String IdProduit;
                String ProduitNom;
                ...
                if (dPremier <= dDeuxieme) {
                    ...
                    jTable2.setModel(new ResultSetTableModel(rs));
                    IdProduit = String.valueOf(jTable2.getValueAt(0, 0));
                    db.queryDelete("produit_entrant", "id=" + IdProduit);
                    ProduitNom = "Produit Entrant";
                }
                db.queryDelete("client_valide", "id=" + id);
                Date s = new Date();
                ...
                String[] inf = {id, "Client Valide", IdProduit, ProduitNom, Numero, Code,
                    Produit, Immatricule, Date_premier, Heure_premier, Premier_pesage,
                ...
                table();
                JOptionPane.showMessageDialog(this, "Le client valide a été supprimé avec succès.");
            } else {
                getToolkit().beep();
