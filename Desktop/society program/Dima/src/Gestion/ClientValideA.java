...
public class ClientValideA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public ClientValideA() {
        ...
        tableImprimante();
        calcultotal();
        Imprimante.setText(String.valueOf(jImprimante.getValueAt(0, 1)));
    }

    void removeTitleBar() {
        putClientProperty("ClientValideA.isPalette", Boolean.TRUE);
 ...
 public void toPDFA7() {
    ...
    public void tableCoordonne() {
        String b[] = {"Id", "Societe", "Adresse", "TEL", "Fax"};
        rs = db.querySelect(b, "cordonee");
        TableModel jTableCordonne = new ResultSetTableModel(rs);
        txnomSoc.setText(String.valueOf(jTableCordonne.getValueAt(0, 1)));
        txAdresseSoc.setText(String.valueOf(jTableCordonne.getValueAt(0, 2)));
        txTelSoc.setText(String.valueOf(jTableCordonne.getValueAt(0, 3)));
        txFaxSoc.setText(String.valueOf(jTableCordonne.getValueAt(0, 4)));
    }

    public void tableImprimante() {
        String b[] = {"ID", "Type"};
        rs = dc.querySelect(b, "imprimante");
        jImprimante.setModel(DbUtils.resultSetToTableModel(rs));
    }
    ...
    public void tableClient() {
        ...
        jClient.setModel(new ResultSetTableModel(rs));
    }
    ...
    public void toPDFMatA4() {
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
            JasperViewer.viewReport(jasperPrint, false);
            JasperExportManager.exportReportToPdfFile(jasperPrint, "BonClientValide.pdf");
            File file = new File("BonClientValide.pdf");
            ...
            Logger.getLogger(ClientValideA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void toPDF2() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("RapportClient.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    public void toPDF3() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("MvClient.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    private void initComponents() {
        ...
        jScrollProduit = new javax.swing.JScrollPane();
        jProduit = new javax.swing.JTable();
        jScrollClient = new javax.swing.JScrollPane();
        jClient = new javax.swing.JTable();
        jScrollImprimante = new javax.swing.JScrollPane();
        jImprimante = new javax.swing.JTable();
        ...
        jScrollProduit.setViewportView(jProduit);
        ...
        jScrollClient.setViewportView(jClient);

        jImprimante.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollImprimante.setViewportView(jImprimante);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ClientValideA.this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
            ...
            rs = db.querySelectTwoALL("client_valide", text1 + "='" + jTextField1.getText() + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (Numero.equals("null")) {
            ...
            rs = db.querySelectAll("client", "Code='" + Code + "'");
            TableModel jTable1 = new ResultSetTableModel(rs);
            String clientNom = String.valueOf(jTable1.getValueAt(0, 1));
            String clientAdress = String.valueOf(jTable1.getValueAt(0, 3));

            rs = db.querySelectAll("produit", "Code='" + Produit + "'");
            TableModel jTable2 = new ResultSetTableModel(rs);
            String produitDesignation = String.valueOf(jTable2.getValueAt(0, 2));
            String produitLot = String.valueOf(jTable2.getValueAt(0, 3));
            String produitPrix = String.valueOf(jTable2.getValueAt(0, 4));
            String prouitCoefficient = String.valueOf(jTable2.getValueAt(0, 5));

            rs = db.querySelectAll("camion", "Immatricule='" + Immatricule + "'");
            TableModel jTable3 = new ResultSetTableModel(rs);
            String CamType = String.valueOf(jTable3.getValueAt(0, 1));
            String CamTare = String.valueOf(jTable3.getValueAt(0, 3));
            ...
            if (Imprimante.getText().equals("Normale A4")) {
                ...
                String[] inf3 = {Numero, "client", Code, clientNom, clientAdress, Produit, produitDesignation, produitLot, produitPrix, prouitCoefficient,
                ...
                Ticket ticket = new Ticket(txnomSoc.getText(), txAdresseSoc.getText(), txTelSoc.getText(), txFaxSoc.getText(), Numero,
                        "client", Code, clientNom, clientAdress, Produit, produitDesignation, produitLot, produitPrix, prouitCoefficient, Immatricule, CamType,
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
            ...
            rs = db.querySelectTwoALL("client_valide", "Code='" + jTextField1.getText() + "'", "Produit='" + jTextField2.getText() + "'", text, deb, fin);
            TableModel jTable3 = new ResultSetTableModel(rs);
            ...
            if (test.equals("null")) {
                ...
                for (int j = 0; j < jTable3.getRowCount(); j++) {
                    ...
                    String[] colon = {"Id", "Code_client", "Nom_client", "Adresse_client", "Produit", "Designation_produit", "Immatricule", "Date_premier", "Premier_pesage", "Date_deuxieme", "Deuxieme_pesage", "Masse_nette", "Totale_Entrer", "Totale_Sortie", "Date_debut", "Date_fin", "Etat"};
                    ...
                    System.out.println(db.queryInsert("mv_client", colon, inf));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        tableClient();
        tableProduit();
        db.queryDelete("rapport_client");

        jProgressBar1.setMaximum(jClient.getRowCount() + jProduit.getRowCount() - 2);

        for (int i = 0; i < jClient.getRowCount(); i++) {

            String CodeClient = String.valueOf(jClient.getValueAt(i, 2));
            // System.out.println("Code Fournisseur: " + CodeFournisseur);
            String NomClient = String.valueOf(jClient.getValueAt(i, 1));
            //System.out.println("Nom Fournisseur: " + NomFournisseur);
            String AdresseClient = String.valueOf(jClient.getValueAt(i, 3));
            ...
            for (int j = 0; j < jProduit.getRowCount(); j++) {
                ...
                // System.out.println("Code produit: " + CodeProduit);
                rs = db.querySelectTwoALL("client_valide", "Code='" + CodeClient + "'", "Produit='" + CodeProduit + "'", text, deb, fin);
                TableModel jTable3 = new ResultSetTableModel(rs);
                ...
                if (Integer.parseInt(TotaleEntrer) != 0 || Integer.parseInt(TotaleSortie) != 0) {
                    ...
                    System.out.println(db.queryInsert("rapport_client", colon, inf));
    ...
    private javax.swing.JTable jImprimante;
    ...
    private javax.swing.JScrollPane jScrollImprimante;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JScrollPane jScrollProduit;
