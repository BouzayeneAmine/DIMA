...
public class ListeConnexion extends javax.swing.JInternalFrame {


    ResultSet rs;
    DbConnection db;

    public ListeConnexion() {
    ...
    void removeTitleBar() {
        putClientProperty("ListeConnexion.isPalette", Boolean.TRUE);
    ...
    public void table() {
        String a[] = {"Id", "Login", "Type", "Date", "Heure", "Nom_PC"};
        rs = db.querySelect(a, "connexion");
   ...
   public void toExcel(JTable table, File file) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Liste des connexions");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Login", "Type", "Nom_PC" }));

        jLabel1.setText("De");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Login", "Type", "Nom_PC" }));
        ...
        jLabel4.setText("Nombre de connexion :");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ListeConnexion.this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (de.getCalendar() == null || a.getCalendar() == null) {
            ...
            if (jComboBox2.getSelectedItem().equals("Login")) {
                text1 = "Login ";
            } else if (jComboBox2.getSelectedItem().equals("Type")) {
                text1 = "Type ";
            } else if (jComboBox2.getSelectedItem().equals("Nom_PC")) {
                text1 = "Nom_PC ";
            } 

            if (jComboBox3.getSelectedItem().equals("Login")) {
                text2 = "Login ";
            } else if (jComboBox3.getSelectedItem().equals("Type")) {
                text2 = "Type ";
            } else if (jComboBox3.getSelectedItem().equals("Nom_PC")) {
                text2 = "Nom_PC ";
            }

            rs = db.querySelectTwoALL("connexion", text1 + "LIKE '%" + jTextField1.getText() + "%' ", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
            jTable1.setModel(new ResultSetTableModel(rs));
            jTable1.getColumnModel().getColumn(0).setMinWidth(0);
            jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
            calcultotal();
