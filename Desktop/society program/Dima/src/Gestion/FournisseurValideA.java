...
public class FournisseurValideA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public FournisseurValideA() {
 ...
 public void toPDFA7() {
    ...
    public void toPDFMatA4() {
        ...
        try {
            ...
            Logger.getLogger(FournisseurValideA.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jScrollPane1.getAccessibleContext().setAccessibleParent(jLabel1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(FournisseurValideA.this);
