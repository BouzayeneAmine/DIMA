...
public class AjouterProduit extends javax.swing.JFrame {
    ...
    void actualiser() {
        txCode.setText("");
        PFinisCheckBox.setSelected(false);
        MPremiereCheckBox.setSelected(false);
    ...
    private void initComponents() {
        ...
        txCode.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        txDesignation.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        txDesignation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txDesignationActionPerformed(evt);
            }
        });
        ...
        txLot.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        txPrix.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        txPrix.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txPrixActionPerformed(evt);
            }
        });
        ...
        PFinisCheckBox.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        PFinisCheckBox.setText("P.Finis");

        buttonGroup1.add(MPremiereCheckBox);
        MPremiereCheckBox.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txCode.getText().equals("") || txDesignation.getText().equals("") || txLot.getText().equals("")
            ...
            String[] colon = {"Code", "Designation", "Lot", "Prix", "type"};
            if (PFinisCheckBox.isSelected())  type= "Produis Finis";
            else if (MPremiereCheckBox.isSelected()) type = "Matiere Premiere";
            String[] inf = {txCode.getText(), txDesignation.getText(), txLot.getText(), txPrix.getText(), type };
    ...
    private void txCodeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txCodeKeyTyped
        char car = evt.getKeyChar();
        if ((car == '\'') || (txCode.getText().length() > 8)) {
            getToolkit().beep();
            evt.consume();
        }
    ...
    private void txPrixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPrixActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txPrixActionPerformed

    private void txDesignationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txDesignationActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txDesignationActionPerformed
