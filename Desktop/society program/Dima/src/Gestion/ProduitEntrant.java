...
public class ProduitEntrant extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static ProduitEntrant obj = null;

    public ProduitEntrant() {
    ...
    public static ProduitEntrant getObj() {
        if (obj == null) {
            obj = new ProduitEntrant();
        }
        return obj;
    }
    ...
    private void initComponents() {
        ...
        setTitle("LISTE PRODUIT ENTRANT");
        ...
        setSize(new java.awt.Dimension(709, 683));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ProduitEntrant.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduitEntrant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProduitEntrant().setVisible(true);
            }
        });
    }
