...
public class AjouterConvayeur extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static AjouterConvayeur obj=null;

    public AjouterConvayeur() {
...
public static  AjouterConvayeur getObj() {
        if (obj == null) {
            obj = new  AjouterConvayeur();
        }
        return obj;
    }
    ...
    public void table() {
        ...
        rs = db.querySelectOrdre(a, "convayeur", "Code");
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Ajouter un Convayeur");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        rs = db.querySelectAll("convayeur", "Code='" + txCode.getText() + "'");
        TableModel jTable = new ResultSetTableModel(rs);
        String txTest = String.valueOf(jTable.getValueAt(0, 2));
        ...
        } else if (!txTest.equals("null")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Ce code convayeur existe déjà !", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else {
            String[] colon = {"Nom", "Code", "Adresse"};
            String[] inf = {txNom.getText(), txCode.getText(), txAdresse.getText()};
            System.out.println(db.queryInsert("convayeur", colon, inf));
            actualiser();
            JOptionPane.showMessageDialog(this, "Le convayeur a été ajouté avec succès.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (txTest1.getText().equals("")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un convayeur dans le tableau !", "Erreur", JOptionPane.ERROR_MESSAGE);
            ...
            if (JOptionPane.showConfirmDialog(this, "Etes-vous sûr de vouloir supprimer ce convayeur ?", "Attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                db.queryDelete("chauffeur", "id=" + id);
                actualiser();
                JOptionPane.showMessageDialog(this, "Le convayeur a été supprimé avec succès.");
            }
        }
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        if (jComboBox1.getSelectedItem().equals("Nom")) {
            rs = db.querySelectAll("convayeur", "Nom LIKE '%" + jTextField1.getText() + "%' ");
        } else if (jComboBox1.getSelectedItem().equals("Code")) {
            rs = db.querySelectAll("convayeur", "Code LIKE '%" + jTextField1.getText() + "%' ");
        } else if (jComboBox1.getSelectedItem().equals("Adresse")) {
            rs = db.querySelectAll("convayeur", "Adresse LIKE '%" + jTextField1.getText() + "%' ");
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
