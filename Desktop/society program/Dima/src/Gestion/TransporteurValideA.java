...
public class TransporteurValideA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public TransporteurValideA() {
 ...
 public void toPDFA7() {
    ...
    public void toPDFMatA4() {
        ...
        try {
            ...
            Logger.getLogger(TransporteurValideA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(TransporteurValideA.this);
