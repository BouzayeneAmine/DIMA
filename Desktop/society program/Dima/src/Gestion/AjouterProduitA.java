...
public class AjouterProduitA extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txCode.getText().equals("") || txDesignation.getText().equals("") || txLot.getText().equals("")
            ...
            if (PFinisCheckBox.isSelected())  type= "Produit Finis";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String Code = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 1));

        rs = db.querySelectAll("produit_sortant", "Code_produit='" + Code + "'");
        TableModel jTable = new ResultSetTableModel(rs);
        String txTest = String.valueOf(jTable.getValueAt(0, 2));

        rs = db.querySelectAll("produit_entrant", "Code_produit='" + Code + "'");
        TableModel jTable2 = new ResultSetTableModel(rs);
        String txTest2 = String.valueOf(jTable2.getValueAt(0, 2));
        if (txTest1.getText().equals("")) {
            ...
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Ce Produit a déja effectué des opérations , Vous ne pouvez pas le supprimer", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else {
