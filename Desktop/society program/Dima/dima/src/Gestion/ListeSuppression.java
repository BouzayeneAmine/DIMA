...
public class ListeSuppression extends javax.swing.JInternalFrame {

    ResultSet rs;
    DbConnection db;

    public ListeSuppression() {
    ...
    void removeTitleBar() {
        putClientProperty("ListeSuppression.isPalette", Boolean.TRUE);
    ...
    public void calcultotal() {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            String b = String.valueOf(jTable1.getValueAt(i, 15));
    ...
    public void table() {
        String a[] = {"Id", "Id_type", "Type", "Id_produit", "Produit_etat", "Numero", "Code", "Produit", "Immatricule", "Date_premier", "Heure_premier", "Premier_pesage", "Date_deuxieme", "Heure_deuxieme", "Deuxieme_pesage", "Masse_nette", "Date_supression", "Nom_machine"};
        rs = db.querySelect(a, "suppression");
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Date d entrée", "Date  de sorite", "Date de suppression" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ListeSuppression.this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (de.getCalendar() == null || a.getCalendar() == null) {
            ...
            if (jComboBox2.getSelectedItem().equals("Type")) {
                ...
                text1 = "Produit ";
            } else if (jComboBox2.getSelectedItem().equals("Immatricule")) {
                text1 = "Immatricule ";
            ...
            rs = db.querySelectTwoALL("suppression", text1 + "LIKE '%" + jTextField1.getText() + "%' ", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
            jTable1.setModel(new ResultSetTableModel(rs));
            jTable1.getColumnModel().getColumn(0).setMinWidth(0);
            jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
            jTable1.getColumnModel().getColumn(1).setMinWidth(1);
        ...
        if (Numero.equals("null")) {
            ...
            if (JOptionPane.showInputDialog(this, "Veuillez saisir votre mot de passe Directeur :", "Verification", JOptionPane.OK_CANCEL_OPTION).equals(password1)) {
                ...
                if (IdTest2.equals("null") && IdTest3.equals("null")) {
                    ...
                    String Immatricule = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 8));
                    String Date_premier = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 9));
                    String Heure_premier = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 10));
                    String Premier_pesage = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 11));
                    String Date_deuxieme = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 12));
                    String Heure_deuxieme = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 13));
                    String Deuxieme_pesage = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 14));
                    String Masse_nette = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 15));
                    String Date = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 16));
                    String machine = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 17));
                    ...
                    String[] colon = {"Id", "Numero", "Code", "Produit", "Immatricule", "Date_premier", "Heure_premier", "Premier_pesage", "Date_deuxieme", "Heure_deuxieme", "Deuxieme_pesage", "Masse_nette"};
                    String[] inf = {idType, Numero, Code, Produit, Immatricule,
                        Date_premier, Heure_premier, Premier_pesage, Date_deuxieme,
                        Heure_deuxieme, Deuxieme_pesage, Masse_nette};
                    System.out.println(db.queryInsert(bdType, colon, inf));

                    String[] colonn = {"Id", "Numero", "Code_produit", "code_type", "Immatricule", "Date_entree", "Heure_entree", "Premier_pesage", "Date_sortie", "Heure_sortie", "Deuxieme_pesage", "Masse_nette"};
                    String[] inff = {idproduit, Numero, Produit, Code, Immatricule, Date_premier, Heure_premier, Premier_pesage, Date_deuxieme,
                        Heure_deuxieme, Deuxieme_pesage, Masse_nette};
                    System.out.println(db.queryInsert(bdproduit, colonn, inff));

                    String[] colo = {"Id_type", "Type", "Id_produit", "Produit_etat", "Numero", "Code", "Produit", "Immatricule", "Date_premier", "Heure_premier", "Premier_pesage", "Date_deuxieme", "Heure_deuxieme", "Deuxieme_pesage", "Masse_nette", "Date_supression", "Nom_machine", "Date_recuperation", "Nom_machine_recuperation"};
                    String[] in = {idType, Type, idproduit, produitetat, Numero, Code, Produit, Immatricule,
                        Date_premier, Heure_premier, Premier_pesage, Date_deuxieme,
                        Heure_deuxieme, Deuxieme_pesage, Masse_nette, Date, machine, txDate + " " + txHeure, hostName};
                    System.out.println(db.queryInsert("recuperation", colo, in));

                    db.queryDelete("suppression", "id=" + zd);
