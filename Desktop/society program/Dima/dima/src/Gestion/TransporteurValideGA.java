...
public class TransporteurValideGA extends javax.swing.JInternalFrame {

    ConnectComPort dc;
    ResultSet rs;
    DbConnection db;

    public TransporteurValideGA() {
    ...
    void removeTitleBar() {
        putClientProperty("TransporteurValideA.isPalette", Boolean.TRUE);
 ...
 public void toPDFA7() {
    ...
    public void tableTransporteur() {
        String a[] = {"Id", "Nom", "Code", "Adresse"};
        rs = db.querySelect(a, "transporteur");
        jTransporteur.setModel(new ResultSetTableModel(rs));
    }
    ...
    public void toPDFMatA4() {
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
            JasperViewer.viewReport(jasperPrint, false);
            JasperExportManager.exportReportToPdfFile(jasperPrint, "BonTransporteurValide.pdf");
            File file = new File("BonTransporteurValide.pdf");
            ...
            Logger.getLogger(TransporteurValideGA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void toPDF2() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("RapportTransporteur.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    public void toPDF3() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("MvTransporteur.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    private void initComponents() {
        ...
        jTransporteur = new javax.swing.JTable();
        ...
        jTransporteur.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane5.setViewportView(jTransporteur);
        ...
        jScrollPane10.setViewportView(jProduit);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(TransporteurValideGA.this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
            rs = db.querySearchAll("transporteur_valide", text, deb, fin);
        } else {
            ...
            rs = db.querySelectTwoALL("transporteur_valide", text1 + "='" + jTextField1.getText() + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (Numero.equals("null")) {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un transporteur pour reimprimer le bon !", "Erreur", JOptionPane.ERROR_MESSAGE);
            getToolkit().beep();
        } else {
            ...
            rs = db.querySelectAll("transporteur", "Code='" + Code + "'");
            ...
            if (Imprimante.getText().equals("Normale A4")) {
                ...
                Ticket ticket = new Ticket(txnomSoc.getText(), txAdresseSoc.getText(), txTelSoc.getText(), txFaxSoc.getText(), Numero,
                        "Transporteur", Code, clientNom, clientAdress, Produit, produitDesignation, produitLot, produitPrix, prouitCoefficient, Immatricule, CamType,
        ...
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
            ...
            if (test.equals("null")) {
                ...
                for (int j = 0; j < jTable3.getRowCount(); j++) {
                    ...
                    String[] colon = {"Id", "Code_transporteur", "Nom_transporteur", "Adresse_transporteur", "Produit", "Designation_produit", "Immatricule", "Date_premier", "Premier_pesage", "Date_deuxieme", "Deuxieme_pesage", "Masse_nette", "Totale_Entrer", "Totale_Sortie", "Date_debut", "Date_fin", "Etat"};
                    ...
                    System.out.println(db.queryInsert("mv_transporteur", colon, inf));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        tableTransporteur();
        tableProduit();
        db.queryDelete("rapport_transporteur");

        jProgressBar1.setMaximum(jTransporteur.getRowCount() + jProduit.getRowCount() - 2);

        for (int i = 0; i < jTransporteur.getRowCount(); i++) {

            String CodeClient = String.valueOf(jTransporteur.getValueAt(i, 2));
            // System.out.println("Code Fournisseur: " + CodeFournisseur);
            String NomClient = String.valueOf(jTransporteur.getValueAt(i, 1));
            //System.out.println("Nom Fournisseur: " + NomFournisseur);
            String AdresseClient = String.valueOf(jTransporteur.getValueAt(i, 3));
            ...
            for (int j = 0; j < jProduit.getRowCount(); j++) {
                ...
                // System.out.println("Code produit: " + CodeProduit);
                rs = db.querySelectTwoALL("transporteur_valide", "Code='" + CodeClient + "'", "Produit='" + CodeProduit + "'", text, deb, fin);
                TableModel jTable3 = new ResultSetTableModel(rs);
                ...
                if (Integer.parseInt(TotaleEntrer) != 0 || Integer.parseInt(TotaleSortie) != 0) {
                    ...
                    System.out.println(db.queryInsert("rapport_transporteur", colon, inf));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (Numero.equals("null")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un transporteur pour le supprimer !", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else {
            String password1 = "";
            ...
            if (JOptionPane.showInputDialog(this, "Veuillez saisir votre mot de passe Directeur :", "Verification", JOptionPane.OK_CANCEL_OPTION).equals(password1)) {
                ...
                db.queryDelete("transporteur_valide", "id=" + id);
                ...
                String[] inf = {id, "Transporteur Valide", IdProduit, ProduitNom, Numero, Code, Produit, Immatricule, Date_premier, Heure_premier,
                    Premier_pesage, Date_deuxieme, Heure_deuxieme, Deuxieme_pesage, Masse_nette, txDate + " " + txHeure, hostName};
                System.out.println(db.queryInsert("Suppression", colon, inf));
                table();
                JOptionPane.showMessageDialog(this, "Le transporteur valide a été suprimé avec succès.");
    ...
    private javax.swing.JTable jTransporteur;
