...
import Gestion.AjouterCamionA;
import Gestion.AjouterFournisseurA;
import Gestion.AjouterClientA;
import Gestion.AjouterTransporteurA;
import Gestion.AjouterProduitA;
import BDD.DbConnection;
import Gestion.APropos;
import Gestion.Aide;
import Gestion.CodeLicence;
import Gestion.ConnPort;
import Gestion.Login;
import Gestion.MiseAJour;
import Gestion.ParametreConnection;
import Gestion.ParametreCoordonee;
...
public class InterfaceAdmin extends javax.swing.JFrame {
    ...
    public InterfaceAdmin() {
        ...
        datecourante();
        this.pack();
        InterfaceAdmin.setDefaultLookAndFeelDecorated(true);
        this.setExtendedState(InterfaceAdmin.MAXIMIZED_BOTH);
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        TransporteurValideA lc = new TransporteurValideA();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        FournisseurValideA lc = new FournisseurValideA();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        this.desk.removeAll();
        this.desk.repaint();
        ClientValideA lc = new ClientValideA();
        this.desk.add(lc);
        try {
            lc.setMaximum(true);
        } catch (PropertyVetoException ex) {
