...
public class AjouterChauffeur extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
        public static AjouterChauffeur obj = null;


    public AjouterChauffeur() {
  ...
  public static AjouterChauffeur getObj() {
        if (obj == null) {
            obj = new AjouterChauffeur();
        }
        return obj;
    }
    ...
    public void table() {
        ...
        rs = db.querySelectOrdre(a, "chauffeur", "Code");
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Ajouter un Chauffeur");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        rs = db.querySelectAll("chauffeur", "Code='" + txCode.getText() + "'");
        ...
        if (txNom.getText().equals("") || txCode.getText().equals("") || txAdresse.getText().equals("")) {
            ...
            System.out.println(db.queryInsert("chauffeur", colon, inf));
            actualiser();
            JOptionPane.showMessageDialog(this, "Le chauffeur a été ajouté avec succès.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (txTest1.getText().equals("")) {
            getToolkit().beep();
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un chauffeur dans le tableau !", "Erreur", JOptionPane.ERROR_MESSAGE);
            ...
            if (JOptionPane.showConfirmDialog(this, "Etes-vous sûr de vouloir supprimer ce chauffeur ?", "Attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                db.queryDelete("chauffeur", "id=" + id);
                actualiser();
                JOptionPane.showMessageDialog(this, "Le chauffeur a été supprimé avec succès.");
            }
        }
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        if (jComboBox1.getSelectedItem().equals("Nom")) {
            rs = db.querySelectAll("chauffeur", "Nom LIKE '%" + jTextField1.getText() + "%' ");
        } else if (jComboBox1.getSelectedItem().equals("Code")) {
            rs = db.querySelectAll("chauffeur", "Code LIKE '%" + jTextField1.getText() + "%' ");
        } else if (jComboBox1.getSelectedItem().equals("Adresse")) {
            rs = db.querySelectAll("chauffeur", "Adresse LIKE '%" + jTextField1.getText() + "%' ");
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
