...
public class TransporteurValide extends javax.swing.JFrame {

    ResultSet rs;
    DbConnection db;
    public static TransporteurValide obj = null;

    public TransporteurValide() {
    ...
    public static TransporteurValide getObj() {
        if (obj == null) {
            obj = new TransporteurValide();
        }
        return obj;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(TransporteurValide.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransporteurValide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransporteurValide().setVisible(true);
            }
        });
    }
