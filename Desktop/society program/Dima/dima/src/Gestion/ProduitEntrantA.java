...
public class ProduitEntrantA extends javax.swing.JInternalFrame {

    ResultSet rs;
    DbConnection db;

    public ProduitEntrantA() {
    ...
    void removeTitleBar() {
        putClientProperty("ProduitEntrantA.isPalette", Boolean.TRUE);
    ...
    public void table30() {
        ...
        rs = db.querySelect(a, "rapport_produit_entrant");
    ...
    public void table40() {
        ...
        rs = db.querySelect(a, "mv_produit_entrant");
    ...
    public void toPDF2() {
        ...
        try {
            ...
            InputStream path = this.getClass().getResourceAsStream("RapportProduitEntrant.jrxml");
    ...
    public void toPDF3() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("MvProduitEntrant.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    public void toPDF4() {
        ...
        try {
            JasperReport jasperReport = null;
            InputStream path = this.getClass().getResourceAsStream("RapportProduitEntrantTotale.jrxml");
            JasperPrint jasperPrint = null;
            jasperReport = JasperCompileManager.compileReport(path);
            HashMap parameters = new HashMap();
            jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, cn.getConexion());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("")) {
            rs = db.querySearchAll("produit_entrant", text, deb, fin);
        } else {
            String text1 = "Numero";
            String text2 = "Numero ";
            ...
            rs = db.querySelectTwoALL("produit_entrant", text1 + "='" + jTextField1.getText() + "'", text2 + "LIKE '%" + jTextField2.getText() + "%' ", text, deb, fin);
        }
        jTable1.setModel(new ResultSetTableModel(rs));
        jTable1.getColumnModel().getColumn(0).setMinWidth(0);
        jTable1.getColumnModel().getColumn(0).setMaxWidth(0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int option = fc.showSaveDialog(ProduitEntrantA.this);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
            ...
            if (testType == true) {
                ...
                rs = db.querySelectTwoALL("produit_entrant", "code_type='" + jTextField1.getText() + "'", "Code_produit='" + jTextField2.getText() + "'", text, deb, fin);
                ...
                if (test.equals("null")) {
                    ...
                    db.queryDelete("mv_produit_entrant");
                    float c = 0;
                    ...
                    for (int j = 0; j < jTable20.getRowCount(); j++) {
                        ...
                        System.out.println(db.queryInsert("mv_produit_entrant", colon, inf));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        db.queryDelete("rapport_produit_entrant");
        ...
        for (int i = 0; i < jTable10.getRowCount(); i++) {
            ...
            for (int j = 0; j < jTable11.getRowCount(); j++) {
                ...
                rs = db.querySelectTwoALL("produit_entrant", "code_type='" + CodeType + "'", "Code_produit='" + CodeProduit + "'", text, deb, fin);
                jTable20.setModel(new ResultSetTableModel(rs));
                ...
                if (Integer.parseInt(Totale) != 0) {
                    ...
                    System.out.println(db.queryInsert("rapport_produit_entrant", colon, inf));
                    DesProduit = "#######";
                }
            }
            Type = "Fournisseur";
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        table10();
        db.queryDelete("rapport_produit_entrant_totale");
        jProgressBar1.setMaximum(jTable10.getRowCount() - 1);
        for (int i = 0; i < jTable10.getRowCount(); i++) {
            String CodeProduit = String.valueOf(jTable10.getValueAt(i, 1));
            String DesProduit = String.valueOf(jTable10.getValueAt(i, 2));

            rs = db.querySelectTwoOne("produit_entrant", "Code_produit='" + CodeProduit + "'", text, deb, fin);
            jTable20.setModel(new ResultSetTableModel(rs));
            ...
            if (c != 0) {
                ...
                System.out.println(db.queryInsert("rapport_produit_entrant_totale", colon, inf));
            }
        }
        toPDF4();
